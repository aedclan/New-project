export const STORAGE_KEY = "personal-hub-data-v1";
export const THEME_KEY = "personal-hub-theme";
export const RECENT_VIEWS_KEY = "personal-hub-recent-views";
...
export const DEFAULT_SORT_BY_PAGE = {
  ...
  tasks: "due-asc",
  bills: "date-desc",
  subscriptions: "date-asc",
  favors: "date-desc",
  notes: "updated-desc",
  collections: "updated-desc",
  favorites: "updated-desc",
  analytics: "updated-desc",
